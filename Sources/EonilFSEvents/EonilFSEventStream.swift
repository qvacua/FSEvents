...
public extension EonilFSEventStream {
  ...
  func scheduleWithRunloop(runLoop: RunLoop, runLoopMode: RunLoop.Mode) {
    ...
    FSEventStreamScheduleWithRunLoop(self.rawref, runLoop.getCFRunLoop(), runLoopMode1)
  }
  ...
  func unscheduleFromRunLoop(runLoop: RunLoop, runLoopMode: RunLoop.Mode) {
    let runLoopMode1 = runLoopMode as CFString
    FSEventStreamUnscheduleFromRunLoop(self.rawref, runLoop.getCFRunLoop(), runLoopMode1)
  }
